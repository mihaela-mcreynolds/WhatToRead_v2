  ...
  <div class="container-fluid" style="padding: 0; height: 100%;">
    ...
    <div class="container" onload = "startQuiz()">
      <div class="container text-center" style="padding:20px; float:left;">
        <h4> One more selection to go! </h4><br><hr>
        <h5 class="display-5" style="color: #8a0e0b;">Choose a third:
        </h5><hr>
        <div class="border border-warning" id = "quiz">
          <!-- Quiz options in a grid of pictures -->
          <div class="row">
            <div class="column">
              <a href="selection_final.php"><img id = "catcherintherye" src="images/catcherintherye.png" alt="The Catcher in the Rye Book Cover"></a>
              <a href="selection_final.php"><img id = "carrie" src="images/carrie.png" alt="Carrie Cover"></a>
            </div>
            <div class="column">
              <a href="selection_final.php"><img id = "amwac" src="images/amwac.png" alt="A Man Without a Country Book Cover"></a>
              <a href="selection_final.php"><img id = "beast" src="images/beast.png" alt="Beast Book Cover"></a>
            </div>
            <div class="column">
              <a href="selection_final.php"><img id= "boc" src="images/boc.png" alt="Breakfast of Champions Book Cover"></a>
              <a href="selection_final.php"><img id = "bookofthief" src="images/bookofthief.png" alt="The Book Thief Book Cover"></a>
            </div>
            <div class="column">
              <a href="selection_final.php"><img id = "faultinourstars" src="images/faultinourstars.png" alt="The Fault in our Stars Book Cover"></a>
              <a href="selection_final.php"><img id = "findingyvonne" src="images/findingyvonne.png" alt="Finding Yvonne Book Cover"></a>
            </div>
          </div>
        </div>
      </div>
